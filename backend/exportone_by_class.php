<?php require_once('common/functions.php');
  ...
  foreach($weekDays as $day) {
    $result = get_by_sql("SELECT * FROM `timetable` where class='$selected' AND day='$day' ORDER BY period");
    if(!empty($result)) {
  ...
  $writer->save('Export_class_wise.xlsx');

  header('location:Export_class_wise.xlsx');
?>