...
class AddTable extends Component {
    ...
    componentDidMount = () => {
        fetch(BASE_URL + "api/get/classes_without_table.php")
        ...
        .then(classdata =>  {
            if(classdata.length) {
                ...
                throw "No Classes in Database Please Add Classes from Add Teacher"
    ...
    handle_submit = event => {
        ...
        fetch(BASE_URL + "api/set/newtable.php",{
            method: "POST",
            headers: {
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 mx-auto my-5">
                            <h4 className="display-4 text-center" > Add TimeTable </h4>
                        </div>
                    </div>
                    <div className="row" >
