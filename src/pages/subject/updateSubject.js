...
class UpdateSubject extends Component {
    ...
    componentDidMount = () => {
        ...
        fetch(BASE_URL + 'api/get/subjects.php?id='+this.props.match.params.id)
    ...
    handleSubmit = event => {
        ...
        fetch(BASE_URL + 'api/update/subject.php',{
            method: "POST",
            headers: {
    ...
    handleModalSubmit = event => {
        ...
        .then(data => { 
            ...
            fetch(BASE_URL + 'api/get/classes.php')
            .then(response => response.json())
            .then(data => { this.setClassList(data) })    
        })
    ...
    render() {
        ...
        return(
            <div>
                ...
                <Modal title="Add Subject" onSubmit={this.handleModalSubmit} >
                ...
                <div className="container-fluid" >
                    <div className="container my-5 px-5" >
                        <h1 className="display-4 text-center">Update Subject</h1>
                        ...
                        <input className="btn btn-danger btn-block" type="submit" value="Update Subject" />
                        </form>
                    </div>
                </div>
            </div>)
